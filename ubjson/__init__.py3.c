 ...
 */
  __pyx_tuple_ = PyTuple_Pack(7, __pyx_n_u_extension_enabled, __pyx_n_u_dump, __pyx_n_u_dumpb, __pyx_n_u_EncoderException, __pyx_n_u_load, __pyx_n_u_loadb, __pyx_n_u_DecoderException); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * __all__ = ('extension_enabled', 'dump', 'dumpb', 'EncoderException', 'load', 'loadb', 'DecoderException')
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_u_0_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
